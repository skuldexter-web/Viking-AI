...
show_installer_banner() {
  ...
  echo -e "${D}${G}                          \|/       \|/"
  echo "                           |         |"
  printf "${Y}  (O)(O)(O)(O)${NC}${C}=============================${Y}(O)(O)(O)(O)\n${NC}"
  printf "${C}            /~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\ \n${NC}"
  printf "${C}  ~^~^~^~^~/  ooo  ooo  ooo  ooo  ooo  ooo   \\ ~^~^~^~\n${NC}"
  printf "${C}  ^~^~^~^~\\~~'~'~~'~'~~'~'~~'~'~~'~'~~'~'~~~/ ^~^~^~^\n${NC}"
  echo -e "${NC}${B}${Y}"
  echo "  ██╗   ██╗██╗██╗  ██╗██╗███╗   ██╗  ██████╗      █████╗ ██╗"
  echo "  ██║   ██║██║██║ ██╔╝██║████╗  ██║ ██╔════╝     ██╔══██╗██║"
  ...
  echo "    ╚═══╝  ╚═╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝  ╚═════╝     ╚═╝  ╚═╝╚═╝"
  echo -e "${NC}"
  echo -e "${G}  Digital Longship Intelligence System  |  @s.k.7.l.d${NC}"
  echo -e "${D}  ═══════════════════════════════════════════════════════${NC}"
  echo ""
}
...
show_banner() {
  clear
  # Ship with colored sails and shields
  echo -e "${D}${G}"
  echo "                           |         |"
  echo "                          /|\       /|\ "
  printf "${RB}                    +-+-+-+-+   +-+-+-+-+\n${NC}"
  ...
  printf "${Y}  (O)(O)(O)(O)${NC}${C}==============================${Y}(O)(O)(O)(O)\n${NC}"
  printf "${C}            /~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\\ \n${NC}"
  printf "${C}  ~^~^~^~^~/  ooo  ooo  ooo  ooo  ooo  ooo  ooo  \\ ~^~^~\n${NC}"
  printf "${C}  ^~^~^~^~\\~~'~'~~'~'~~'~'~~'~'~~'~'~~'~'~~'~'~~/ ^~^~^\n${NC}"
  echo -e "${NC}${B}${Y}"
  echo "  ██╗   ██╗██╗██╗  ██╗██╗███╗   ██╗  ██████╗      █████╗ ██╗"
  echo "  ██║   ██║██║██║ ██╔╝██║████╗  ██║ ██╔════╝     ██╔══██╗██║"
